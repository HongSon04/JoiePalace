...
const SliderMenuDish = ({ title, dataSlider, logo }) => {
                                ...
                                <div className="flex justify-center items-center rounded-full border-gold border w-fit h-fit p-[10px]">
                                    <div className="flex justify-center items-center w-[200px] h-[200px] max-2md:w-[150px] max-2md:h-[150px] bg">
                                        <Image
                                            ...
                                            alt={dataSlider[0].name}
                                        />
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-col gap-6 ">
                                <h1 className="font-bold text-xl leading-[40px] text-left font-gilroy uppercase max-2md:text-lg">{dataSlider[0].name}</h1>
                                <p className="font-normal text-lg leading-[40px] text-left font-gilroy max-2md:text-base">{dataSlider[0].price}</p>
                                <p className="font-normal text-base text-left font-gilroy w-[80%] max-2md:text-[13px]">{dataSlider[0].description}</p>
                                <Link className="font-normal text-lg leading-[40px] text-left font-gilroy text-gold border-b border-gold hover:text-gold w-fit max-2md:text-base" href={dataSlider[0].link}>Khám phá</Link>
                            </div>
                        </div>
                    ) : (
