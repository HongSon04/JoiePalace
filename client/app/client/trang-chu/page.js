...
const events = [
  [
    ...
    },
    {
      id: 2,
      content:
        "KHI SẮC TRẮNG THANH KHIẾT TÔ ĐIỂM CHO KHÔNG GIAN CƯỚI NGHỆ THUẬT CỦA JOIE PALACE PHẠM VĂN ĐỒNG",
      urlImage: "/images-client/events/46-1.jpg",
    },
    {
      id: 3,
      content:
        "ĐẠI HỘI ĐẠI BIỂU LẦN IX CỦA HAWA: JOIE PALACE PHẠM VĂN ĐỒNG ĐÓN TIẾP CỘNG ĐỒNG DOANH NGHIỆP NGÀNH GỖ VÀ MỸ NGHỆ",
      ...
      <section className="section banner w-full h-screen relative top-0 left-0">
        ...
        >
          ...
          <span className="text-base font-normal leading-6 text-center w-[80%] 2md:w-[50%]">
            ...
            hội nghị và sự kiện cao cấp, JOIE PALACE luôn được chọn là địa điểm
